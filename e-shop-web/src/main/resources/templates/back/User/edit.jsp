...
<script type="text/javascript">
	$(function() {
		...
		$("#savebtn").click(function() {
			...
			/* var bool = true;
			if(password!="${pageScope.oldUser.password}"){
				bool = false;
			}
			if(truename!="${pageScope.oldUser.truename}"){
				bool = false;
			}
			if(phone!="${pageScope.oldUser.phone}"){
				bool = false;
			}
			if(address!="${pageScope.oldUser.address}"){
				bool = false;
			}
			if(userStatus!="${pageScope.oldUser.userStatus}"){
				bool = false;
			}
			if(bool){
				return;
